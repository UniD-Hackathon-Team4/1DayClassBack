...
import com.example.DayClassBack.dto.request.UserRequestDto;
import com.example.DayClassBack.dto.response.UserResponseDto;
import com.example.DayClassBack.entity.Users;
import com.example.DayClassBack.enums.Authority;
import com.example.DayClassBack.jwt.JwtTokenProvider;
import com.example.DayClassBack.repository.UsersRepository;
import com.example.DayClassBack.security.SecurityUtil;
...
public class UsersService {
    ...
    public Users findById(Long id) {
        Users user = usersRepository.findById(id).orElseThrow(()->new IllegalArgumentException("해당 사용자가 없습니다. id="+id));
